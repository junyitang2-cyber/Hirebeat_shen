...
const ORDER_TABLE = "Order-6nkm7pt2bbb3bdqzly7qdbxxua-dev";
const ORDER_TYPE = "Order";
const PLAN_TABLE = "Plans-6nkm7pt2bbb3bdqzly7qdbxxua-dev";
const PLAN_ORDER_TYPE = "Plans";

const createOrder = async (payload) => {
  const { orderId, username, email, total } = payload;
